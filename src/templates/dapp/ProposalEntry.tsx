...
const ProposalEntry = ({
  ...
  setCurrentProposalForDialog,
  setCurrentVoteAction,
}: ProposalEntryProps) => {
  let proposalTypeBadge;
  if (govContractEntry.create) {
    proposalTypeBadge = (
      <span className="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Create</span>
    );
  } else {
    proposalTypeBadge = (
      <span className="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">Remove</span>
    );
  }
  ...
  return (
    <tr className="border-b border-gray-200 hover:bg-gray-100">
      <td className="py-3 px-6 text-left whitespace-nowrap">
        <div className="flex items-center">{memeIdElement}</div>
      </td>
      <td className="py-3 px-6 text-center">{proposalTypeBadge}</td>
      <td className="py-3 px-6 text-center">{inProgressBadge}</td>
      <td className="py-3 px-6 text-center">
        <div className="flex items-center justify-center">{govContractEntry.votesInFavor}</div>
      </td>
      <td className="py-3 px-6 text-center">
        <div className="flex items-center justify-center">{govContractEntry.votesAgainst}</div>
      </td>
      <td className="py-3 px-6 text-center">
