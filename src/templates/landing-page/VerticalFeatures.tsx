...
const VerticalFeatures = () => (
  ...
  >
    ...
    <VerticalFeatureRow
      ...
      description="Yes, we all know that there's always a new cooler meme around. You can make a proposal to add a new meme in the protocol. With the minimum quorum of 3 users holding GAS, your proposal can get elected or not."
